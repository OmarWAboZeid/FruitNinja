...
public class Heart extends FruitState implements  FruitStrategy{


    public Heart(){

    }
    public Heart(Rectangle2D bounds, String mode) {
        ...
        this.image = new Image("Assets/ezgif.com-resize.gif");
