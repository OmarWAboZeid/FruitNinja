...
public class Starfruit extends FruitState implements  FruitStrategy{


    public Starfruit(){

    }
    public Starfruit(Rectangle2D bounds, String mode) {
        ...
        this.image = new Image("Assets/starfruitz.png");
